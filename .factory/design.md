...
Generated with the factory Azure image deployment (`factory-image`) on 2026-08-28. The selected output is original to this product and shipped as WebP/AVIF with a PNG source and prompt sidecar in `assets/src/`. Application icons and small line illustrations are hand-authored SVG and MIT-licensed with the repository.
